...
from Modulo_dsaentidades.cliente import Cliente

# Importa a classe base Conta e suas subclasses (Corrente e Poupança)
from Modulo_dsaentidades.conta import Conta, ContaCorrente, ContaPoupanca

# Importa exceção personalizada para conta inexistente
from Modulo_dsautilitarios.exceptions import ContaInexistenteError
